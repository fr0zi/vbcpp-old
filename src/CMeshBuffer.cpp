...
CMeshBuffer::CMeshBuffer(Lib3dsFile* file, Lib3dsMaterial* material, vbcString texPath)
{
...
CMeshBuffer::~CMeshBuffer()
{
	...
	GLuint CMeshBuffer::getNormalBufferID()
	{
		return m_NormalBufferID;
	}

	GLuint CMeshBuffer::getTexCoordBufferID()
	{
	...
	Lib3dsVector* CMeshBuffer::getVertices()
	{
		return m_Vertices;
	}

	Lib3dsVector* CMeshBuffer::getNormals()
	{
		return m_Normals;
	}

	Lib3dsTexel* CMeshBuffer::getTexCoords()
	{
		return m_TexCoords;
	}
	...
	void CMeshBuffer::loadGeometry(Lib3dsFile* file, Lib3dsMaterial* material)
	{
		Lib3dsMesh* mesh;
		Lib3dsFace* face;

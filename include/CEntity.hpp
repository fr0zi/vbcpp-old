#ifndef CENTITY_HPP_INCLUDED
#define CENTITY_HPP_INCLUDED
...
class CEntity : virtual public CReferenceCounter
{
	public:

        //! CONSTRUCTOR
		CEntity(CEntity* parent = 0, vbcString name = "",
        ...
        //! Add child Entity
        virtual void addChild(CEntity* child)
        {
			if( child && (child != this) )
			{
				child->grab();
        ...
        virtual bool removeChild(CEntity* child)
        {
        ...
        //! Set parent Entity
        virtual void setParent(CEntity* parent)
        {
			grab();
			remove();
